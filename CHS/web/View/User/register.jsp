...
<head>
	...
	<link rel="stylesheet" href="${appPublic}/User/css/register.css">
</head>
<body>
<div class="container">
	<div class="header">
	...
	<div class="login">
		...
		<div class="login-form">
			<form id="register-form" method="post">
				...
				<div class="form-group">
					<label class="form-label icon-tag"></label>
					<div class="form-item">
						<input class="form-input" type="text" name="name" autocomplete="off" placeholder="请在此输入名称..."/>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label class="form-label icon-lock"></label>
					<div class="form-item">
						<input class="form-input" type="password" name="passwordAgain" autocomplete="off" placeholder="请再次输入密码..."/>
					</div>
				</div>
				<div class="form-submit">
					<button class="btn-submit" type="button">注册</button>
				</div>
			</form>
		</div>
	</div>
...
<script src="${appPublic}/User/js/register.js"></script>
</body>
</html>